<template>
    ...
    <div class="Rubik text-[50px]"style="
            background: linear-gradient(270deg, rgba(105,224,255,1) 10%, rgba(255,82,185,1) 100%);
            -webkit-background-clip: text;
            color: transparent;
    ...
    you beyond the ordinary, making every interaction unforgettable.
      ...
      <div class="banner">
        <div class="slider" style="--quantity: 10">
          <div v-for="n in 10" :key="n" class="item" :style="`--position: ${n}`">
            <img :src="`/images/img/dragon_${n}.jpg`" alt=""  class="rounded-lg"/>
          </div>
        </div>
        <div class="content">
  ...
  * {
  ...
  /* ใส่ style เพิ่มเติมของ .slider, .item, .content ตาม style.css ได้เลย */
  </style>
